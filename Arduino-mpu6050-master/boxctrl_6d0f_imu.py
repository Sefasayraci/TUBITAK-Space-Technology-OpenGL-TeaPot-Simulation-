#!/usr/bin/env python
# Kaynak: https://www.youtube.com/watch?v=yqFfmwVufMo
# Kaynak_2: http://web.archive.org/web/20190626080855/http://mattzz.no-ip.org/wiki/Projects/PlayingWithInertialMeasurementUnits
